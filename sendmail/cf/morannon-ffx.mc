#:ts=8
#
# $Id: morannon-ffx.mc,v 4.1 1996/09/22 12:23:31 mj Exp $
#
# Fido.DE domain gateway sendmail V8 configuration
#
# $Log: morannon-ffx.mc,v $
# Revision 4.1  1996/09/22 12:23:31  mj
# See ChangeLog
#
...
include(`../m4/cf.m4')
VERSIONID(`$Id: morannon-ffx.mc,v 4.1 1996/09/22 12:23:31 mj Exp $')
OSTYPE(linux)dnl
